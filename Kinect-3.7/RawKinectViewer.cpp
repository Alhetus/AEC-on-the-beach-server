	  ...
	  mainMenu(0), averageDepthFrameDialog(0)
{
	...
	*********************************************************************/
	...
	{
		std::cout << "opened depth socket" << std::endl;
	}
	...
	std::cout << "listening " << serv_addr.sin_addr.s_addr << " " << portno << std::endl;
	...
	if (!depthValueRangeRequested)
	{
		...
		std::cout << "Min depth range: " << depthValueRange[0] << std::endl;
		std::cout << "Max depth range: " << depthValueRange[1] << std::endl;
	}
